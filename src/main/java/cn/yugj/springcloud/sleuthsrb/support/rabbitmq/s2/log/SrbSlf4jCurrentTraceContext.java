...
public final class SrbSlf4jCurrentTraceContext extends CurrentTraceContext {
	...
	private static final Logger log = LoggerFactory
			.getLogger(SrbSlf4jCurrentTraceContext.class);

	public static SrbSlf4jCurrentTraceContext create() {
		return create(Default.inheritable());
	}

	public static SrbSlf4jCurrentTraceContext create(CurrentTraceContext delegate) {
		return new SrbSlf4jCurrentTraceContext(delegate);
	}

	final CurrentTraceContext delegate;

	SrbSlf4jCurrentTraceContext(CurrentTraceContext delegate) {
		if (delegate == null)
